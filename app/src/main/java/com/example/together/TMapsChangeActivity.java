...
public class TMapsChangeActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tmaps_change);
        ...
        saved1.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(TMapsChangeActivity.this, TaxiChangePostActivity.class);
        ...
        et1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Autocomplete.IntentBuilder(AutocompleteActivityMode.OVERLAY,
                        fieldList).build(TMapsChangeActivity.this);
